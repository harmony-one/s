...
import { JoinGroup, Navbar, WalletConnectButton } from '../Components';
...
const SocialBond = () => {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
    <Navbar open={open} setOpen={setOpen} pageTitle="Social Bond" />
    <Main open={open}>
      <DrawerHeader />
      { myOTP ? 
      <JoinGroup myOTP={myOTP} /> : <WalletConnectButton /> }
    </Main>
  </Box>
  )
}

export default SocialBond;