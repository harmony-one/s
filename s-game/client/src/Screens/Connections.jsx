...
import { Navbar, WalletConnectButton, ViewConnections } from '../Components';
...
const Connections = () => {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
    <Navbar open={open} setOpen={setOpen} pageTitle="Connections" />
    <Main open={open}>
      <DrawerHeader />
      { myOTP ? 
      <ViewConnections myOTP={myOTP} /> : <WalletConnectButton /> }
    </Main>
  </Box>
  )
}
