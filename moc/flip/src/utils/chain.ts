...
function containsAddr(addr1: string, addrs: string[]): boolean {
  return addrs.some(addr2 => addr1.toLowerCase() === addr2.toLowerCase());
}

export {
  // getDstChain, getDstAsset, shortenHash, getExplorer, 
  isAddrEqual, containsAddr
};